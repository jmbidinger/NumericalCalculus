...
# Loop to see the approximation get closer to WolframAlpha's ~= 0.783431...
def viewApproximations(f,a,b,ns1,nsk):
    for i in range(ns1,nsk):
	print i,"\t",trapIntegrate(f, 0, 1, i)
